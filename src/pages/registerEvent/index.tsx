...
const Register = () => {
  ...
  const [form, setForm] = useState<requestCreate>({} as requestCreate);
  ...
  return (
    <ScrollView>
      <Box marginTop={10} alignItems="center" pb={10}>
        ...
        <Flex direction="row" width="90%" justifyContent="center" alignItems="center" mb={5}>
          ...
          <ButtonSimple
            ...
            onPress={() => {
              setForm({
                ...form,
                categorias: form?.categorias ? [...form?.categorias, { title: categoria }] : [{ title: categoria }],
              });
              setCategoria("");
            }}
          >
        ...
        <Flex direction="row" width="90%" mb={5}>
          ...
          <FormControl isRequired flex={2} width="90%" mb={5} isInvalid={!form.postalCod && submit ? true : false}>
            ...
            <Input
              ...
              rightElement={load ? <Spinner mr={5} color="primary.200" /> : null}
            />
            <FormControl.ErrorMessage leftIcon={<WarningOutlineIcon size="xs" />}>
        ...
        <ButtonSimple isLoading={load} isLoadingText="Submitting" onPress={createEventFun} mt={6}>
          Criar Evento
        </ButtonSimple>
      </Box>
    </ScrollView>
